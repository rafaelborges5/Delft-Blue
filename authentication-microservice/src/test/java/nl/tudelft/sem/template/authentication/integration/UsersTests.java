...
public class UsersTests {
    ...
    public void register_withValidData_worksCorrectly() throws Exception {
        ...
        //TODO: is it possible to generate a test case for the role, because UserDetails is a predefined class
    }
    ...
    public void login_withInvalidPassword_returns403() throws Exception {
        ...
        AppUser appUser = new AppUser(new NetId(testUser), testHashedPassword, testRole);
        userRepository.save(appUser);
