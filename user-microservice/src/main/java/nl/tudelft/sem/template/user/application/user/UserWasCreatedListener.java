package nl.tudelft.sem.template.user.application.user;

import nl.tudelft.sem.template.user.domain.user.UserWasCreatedEvent;
...
public class UserWasCreatedListener {
    /**
     * The name of the function indicated whic
     * h event is listened to.
