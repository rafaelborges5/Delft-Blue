...
class JwtRequestFilterTest {
    ...
    public void correctToken() throws ServletException, IOException {
        ...
        when(mockJwtTokenVerifier.getRole(token)).thenReturn(role);
        when(mockJwtTokenVerifier.getFaculties(token)).thenReturn(faculty);
