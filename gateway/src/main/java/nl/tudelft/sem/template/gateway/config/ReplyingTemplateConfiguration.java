...
public class ReplyingTemplateConfiguration {
    ...
    @Bean
    public ReplyingKafkaTemplate<String, FacultyNameDTO, PendingRequestsDTO>
    replyKafkaTemplate(ProducerFactory<String, FacultyNameDTO> pf,
                       KafkaMessageListenerContainer<String, PendingRequestsDTO> container) {
        return new ReplyingKafkaTemplate<>(pf, container);
    }

    @Bean
    public KafkaMessageListenerContainer<String, PendingRequestsDTO> replyContainer(ConsumerFactory<String, PendingRequestsDTO> cf) {
